...
model_checkpoints = callbacks.ModelCheckpoint(p+"/model/checkpoint-7labels-{val_loss:.3f}.h5", verbose=0,period=0,monitor='val_loss', save_best_only=True, save_weights_only=False, mode='auto')
model.summary()
